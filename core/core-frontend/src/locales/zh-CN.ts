export default {
  ...
  system: {
    ...
    organization: {
      ...
      active: '正常',
      inactive: '禁用',
      select_node_tip: '请选择左侧组织节点查看详情',
      input_dept_name: '请输入部门名称',
      ...
      select_dept: '请选择部门',
      edit_dept: '编辑部门',
      create_dept_success: '创建部门成功',
      update_dept_success: '更新部门成功',
      delete_dept_success: '删除部门成功',
      delete_dept_confirm: '确定删除该部门吗？删除后子部门将一并删除',
      create_user_success: '创建用户成功',
      update_user_success: '更新用户成功',
      delete_user_success: '删除用户成功',
      delete_user_confirm: '确定删除该用户吗？'
    }
  },
  components: {
